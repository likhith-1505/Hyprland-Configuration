...
local menu = "/home/asta/.config/rofi/launchers/type-1/launcher.sh"
...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("/home/asta/.config/waybar/launch.sh"))
hl.bind(
	mainMod .. " + SHIFT + V",
...
hl.bind(mainMod .. " + F", hl.dsp.exec_cmd("flatpak run io.gitlab.librewolf-community"))
...
-- Enter resize mode
hl.bind(mainMod .. " + G", hl.dsp.submap("resize"))
